...
/******************************************************************************/
[#compress]
[#if S_CORTEX_A35_START?? && S_CORTEX_A35_START="true"]
/* When M33TD_AppCore utility is enabled, NMI, HardFault, SecureFault, MemManage, BusFault,
 * UsageFault and SecureFault are handeled in fault_manager.c
 * */
#ifndef USE_M33TD_NSAPPCORE_FAULTMGR
[/#if]
[#list nvic as vector]
[#if S_CORTEX_A35_START?? && S_CORTEX_A35_START="true"]
[#if vector.irqHandler == "DebugMon_Handler" ] #endif[/#if]
[/#if]
...
[#if vector?? && !vector.systemHandler && vector.irqHandlerGenerated && !listOfIrq?contains(vector.irqHandler)]
[#assign listOfIrq = listOfIrq + vector.irqHandler]
/**
#t* @brief  This function handles ${vector.comment}.  
#t*/
void ${vector.irqHandler}(void)
